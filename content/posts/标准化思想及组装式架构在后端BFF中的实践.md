...
tags: [美团技术团队, 到店, 后台, BFF, “架构”, 组装式开发]
---
...
![图1 产品功能形态](https://p0.meituan.net/travelcube/a3fed2681559314dd7c40499b487506b4753431.gif)
...
![图2 研发的主要工作](https://img.meituan.net/dpmobile/bf90134cc4144b472dc77c62a43920b457520.png)
...
![图3 “标准化原理”的应用](https://img.meituan.net/dpmobile/b9d961fbe4e3c751d1aa29da30bd5f70726795.png)
...
![图4 组装式开发可行性以及关键思路](https://img.meituan.net/dpmobile/984928deeca5f5243bf1f391b52d3f4b110130.png)
...
* **功能组件提取与预组�**�：组件标准化是组装式开发的前提，所以我们需要先将组件提取出来。在最终组装功能的时候，为了降低组装的复杂性，我们引入了“预组装”的概念。针对每个系列的产品功能，我们将通用部分提前组装好，将定制部分提前预留出来，定制部分包括功能和特性的定制，这部分可延迟到需要的时候再组装。
...
* **可视化组装与配置填�**��：细颗粒度的组件带来了一定的组装复杂性，为简化组装过程，我们将可用组件呈现在用户的界面上，开发同学通过点击鼠标即可完成组件的组装，而对于功能特性组件的配置填充，也是在用户界面上直接完成的。
...
![图5 信息类产品功能归类思路](https://img.meituan.net/dpmobile/8bc9849ff81e403e4908e55514ec8703387172.png)
...
![图6 标准接口+多租户模式](https://img.meituan.net/dpmobile/8786175812856951ca323d0065202847254636.png)
...
![图7 组件提取案例](https://img.meituan.net/dpmobile/4c055e5f631be02cd47be70ab4ffe6ee301792.png)
...
![图8 有筛选和没筛选之间的差别](https://img.meituan.net/dpmobile/cab7bbcb3f8a52238d43cb45ba3cf4b8324483.png)
...
![图9 不同情况组装逻辑不一样](https://img.meituan.net/dpmobile/c4a0869a2e7d23e8016a8aa9910b744b212095.png)
...
![图10 易变功能通过变化点-可选项-配置项建模](https://img.meituan.net/dpmobile/b43ad500165ba24223b14c3852f5ac9a226188.png)
...
![图11 选功能-选特性-填配置](https://img.meituan.net/dpmobile/bac2368ea0edd4e3de892d756fede47e369067.png)
...
* **配置填�**��：经过以上两个步骤，基本确定了当前要组装的展示功能所需的组件集合，但有的组件是有配置项的，比如前文举的查询商品ID这个组件，填充查询渠道配置项就是在这一步完成的。
...
* \[2\] [GraphQL及元数据驱动架构在后端BFF中的实践](https://mp.weixin.qq.com/s/mhM9tfWBlIuMVkZQ-6C0Tw)
